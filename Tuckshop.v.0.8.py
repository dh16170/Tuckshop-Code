...
def subschoose():
    subs = StringVar(root)
    subslist = {('Chicken Sub', '$3.50'), ('Meatball Sub', '$3.50'), ('Pork Riblet', '$3.50')}
    subs.set('Chicken Sub', '$3.50')
...
quantityframe.place(relx=0.6, rely=0, relwidth=0.1, relheight=1)

priceframe = Frame(printlistframe, pady=5, padx=5)
priceframe.place(relx=0.7, rely=0, relwidth=0.3, relheight=1)
